...
// Logic: check whether div with class 'cover' is currently visible or not. If visible, then nav-bar = dark; else, colorful.
...
// Then we pick a random integer for the position of the "stars", and pick one color out of the colorScheme. (animation also entirely in css)
